insert into comics(id, link, thumbnail_uri, title, week, week_frequency_code) values(1, "uri", "uri", "comic1", "ThrFri", "EVERY");
...
insert into comics(id, link, thumbnail_uri, title, week, week_frequency_code) values(5, "uri", "uri", "comic5", "Mon", "EVERY");